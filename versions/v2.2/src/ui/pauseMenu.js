...
export function createPauseMenu({ onSensitivity, onVolume, onRestart, onToggle, onTime, onEffects, onSave }) {
  let paused = false;
  ...
  if (onSave) panel.appendChild(makeButton("💾  Guardar partida", "#2a5b7a", () => onSave()));
  const restartBtn = makeButton("↻  Partida nueva", "#7a2e2e", () => onRestart());
