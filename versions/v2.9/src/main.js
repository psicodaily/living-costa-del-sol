...
async function init() {
  ...
  car.group.position.y = heightAt(car.group.position.x, car.group.position.z);
  ...
  if (saved) {
    ...
    if (typeof saved.px === "number") player.group.position.set(saved.px, heightAt(saved.px, saved.pz), saved.pz);
  }
