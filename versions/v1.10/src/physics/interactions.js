  ...
  function driveCollisions(vehicle, onShake) {
    ...
    for (const v of fleet.vehicles) {
      ...
      if (d > 0.001 && d < minD) {
        ...
        vehicle.slow(0.55); // frena en el contacto
        // Abolladura solo en golpes fuertes (el slow baja rápido la velocidad,
        // así no se abolla cada fotograma mientras están en contacto).
        if (spd > 6) {
